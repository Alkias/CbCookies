import {varknoband_data, template } from "./template";
...
export const run = (data)=>{
    ...
    $( function () {
      ...
      template(data);
        ...
        var $mainCookiesDialog = $(".fc-consent-root");
        ...
        var $primaryConsentButton = $(".fc-button.fc-cta-consent.fc-primary-button");
        var $cofirmChoisestButton = $(".fc-button.fc-confirm-choices.fc-primary-button");
        ...
        $primaryConsentButton.on( "click", function ( event ) {
          var choices = $mainCookiesDialog.find( ":checkbox" );
          //debugger;
          ...
          //$mainCookiesDialog.hide();

          alert("Consent");
        } )

        $cofirmChoisestButton.on( "click", function ( event ) {
        ...
        $consentAcceptAllButton.on( "click", function ( event ){ 
            ...
            data.forEach(cookieType => {
              let checkbox = document.querySelector(
                  "input." + cookieType.systemName
              );
              if (checkbox) {
